...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='paddle/fluid/framework/pass_desc.proto',
  ...
  ,
  dependencies=[paddle_dot_fluid_dot_framework_dot_framework__pb2.DESCRIPTOR,])
...
_PASSDESC_OPERATION.fields_by_name['value'].message_type = paddle_dot_fluid_dot_framework_dot_framework__pb2._OPDESC_ATTR
...
_PASSDESC_ATTRCONDITION.fields_by_name['condition_value'].message_type = paddle_dot_fluid_dot_framework_dot_framework__pb2._OPDESC_ATTR
...
_PASSDESC.fields_by_name['pattern'].message_type = paddle_dot_fluid_dot_framework_dot_framework__pb2._OPDESC
_PASSDESC.fields_by_name['replace'].message_type = paddle_dot_fluid_dot_framework_dot_framework__pb2._OPDESC
...
PassDesc = _reflection.GeneratedProtocolMessageType('PassDesc', (_message.Message,), dict(
  ...
  Attr = _reflection.GeneratedProtocolMessageType('Attr', (_message.Message,), dict(
    ...
    __module__ = 'paddle.base.framework.pass_desc_pb2'
