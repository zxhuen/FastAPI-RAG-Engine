...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='paddle/fluid/framework/framework.proto',
...
_ATTRTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SCALAR', index=16, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SCALARS', index=17, number=17,
      options=None,
      type=None),
  ],
...
_SCALAR_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='paddle.framework.proto.Scalar.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPLEX128', index=3, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_COMPLEX = _descriptor.Descriptor(
  name='Complex',
  full_name='paddle.framework.proto.Complex',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='r', full_name='paddle.framework.proto.Complex.r', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i', full_name='paddle.framework.proto.Complex.i', index=1,
...
_SCALAR = _descriptor.Descriptor(
  name='Scalar',
  full_name='paddle.framework.proto.Scalar',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='paddle.framework.proto.Scalar.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='b', full_name='paddle.framework.proto.Scalar.b', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i', full_name='paddle.framework.proto.Scalar.i', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='r', full_name='paddle.framework.proto.Scalar.r', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='c', full_name='paddle.framework.proto.Scalar.c', index=4,
...
_OPDESC_ATTR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scalar', full_name='paddle.framework.proto.OpDesc.Attr.scalar', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scalars', full_name='paddle.framework.proto.OpDesc.Attr.scalars', index=19,
...
_SCALAR.fields_by_name['c'].message_type = _COMPLEX
_SCALAR_TYPE.containing_type = _SCALAR
_OPDESC_ATTR.fields_by_name['type'].enum_type = _ATTRTYPE
_OPDESC_ATTR.fields_by_name['scalar'].message_type = _SCALAR
_OPDESC_ATTR.fields_by_name['scalars'].message_type = _SCALAR
...
Version = _reflection.GeneratedProtocolMessageType('Version', (_message.Message,), dict(
  DESCRIPTOR = _VERSION,
  __module__ = 'paddle.base.framework.framework_pb2'
