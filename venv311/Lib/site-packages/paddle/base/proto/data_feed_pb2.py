...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='paddle/fluid/framework/data_feed.proto',
...
_GRAPHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sage_mode', full_name='paddle.framework.GraphConfig.sage_mode', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='samples', full_name='paddle.framework.GraphConfig.samples', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='train_table_cap', full_name='paddle.framework.GraphConfig.train_table_cap', index=12,
      number=13, type=3, cpp_type=2, label=1,
      has_default_value=True, default_value=80000,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='infer_table_cap', full_name='paddle.framework.GraphConfig.infer_table_cap', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='excluded_train_pair', full_name='paddle.framework.GraphConfig.excluded_train_pair', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='infer_node_type', full_name='paddle.framework.GraphConfig.infer_node_type', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_degree', full_name='paddle.framework.GraphConfig.get_degree', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted_sample', full_name='paddle.framework.GraphConfig.weighted_sample', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='return_weight', full_name='paddle.framework.GraphConfig.return_weight', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pair_label', full_name='paddle.framework.GraphConfig.pair_label', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_thread_sharding', full_name='paddle.framework.GraphConfig.is_thread_sharding', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='accumulate_num', full_name='paddle.framework.GraphConfig.accumulate_num', index=21,
...
Slot = _reflection.GeneratedProtocolMessageType('Slot', (_message.Message,), dict(
  DESCRIPTOR = _SLOT,
  __module__ = 'paddle.base.framework.data_feed_pb2'
