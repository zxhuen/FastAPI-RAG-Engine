...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='paddle/fluid/framework/trainer_desc.proto',
  ...
  ,
  dependencies=[paddle_dot_fluid_dot_framework_dot_data__feed__pb2.DESCRIPTOR,paddle_dot_fluid_dot_framework_dot_framework__pb2.DESCRIPTOR,])
...
_TRAINERDESC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dump_fields_mode', full_name='paddle.framework.TrainerDesc.dump_fields_mode', index=38,
      number=39, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("w").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='dump_num_decimals', full_name='paddle.framework.TrainerDesc.dump_num_decimals', index=39,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hogwild_param', full_name='paddle.framework.TrainerDesc.hogwild_param', index=40,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='downpour_param', full_name='paddle.framework.TrainerDesc.downpour_param', index=41,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pull_dense_param', full_name='paddle.framework.TrainerDesc.pull_dense_param', index=42,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='section_param', full_name='paddle.framework.TrainerDesc.section_param', index=43,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='heter_section_param', full_name='paddle.framework.TrainerDesc.heter_section_param', index=44,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_desc', full_name='paddle.framework.TrainerDesc.data_desc', index=45,
...
_TRAINERDESC.fields_by_name['data_desc'].message_type = paddle_dot_fluid_dot_framework_dot_data__feed__pb2._DATAFEEDDESC
...
_SECTIONCONFIG.fields_by_name['program_desc'].message_type = paddle_dot_fluid_dot_framework_dot_framework__pb2._PROGRAMDESC
...
TrainerDesc = _reflection.GeneratedProtocolMessageType('TrainerDesc', (_message.Message,), dict(
  ...
  __module__ = 'paddle.base.framework.trainer_desc_pb2'
