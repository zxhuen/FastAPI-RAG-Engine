...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='paddle/fluid/distributed/ps.proto',
  package='paddle',
  syntax='proto2',
...
_PSCMDID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PS_SAVE_ONE_TABLE_PREFIX', index=21, number=21,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PS_SAVE_MEM_CACHE_TABLE', index=22, number=22,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PS_S2S_MSG', index=23, number=101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PS_C2C_PULL_SPARSE_TABLE', index=24, number=201,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_TABLEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sparse_table_mem_cache_rate', full_name='paddle.TableParameter.sparse_table_mem_cache_rate', index=9,
...
PSParameter = _reflection.GeneratedProtocolMessageType('PSParameter', (_message.Message,), dict(
  ...
  __module__ = 'paddle.base.distributed.ps_pb2'
